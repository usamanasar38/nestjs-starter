...
import { DepositBodyDTO } from '@account/interface/dto/deposit.body.dto';
import { FindAccountsQueryDTO } from '@account/interface/dto/find-accounts.query.dto';
import { OpenAccountBodyDTO } from '@account/interface/dto/open-account.body.dto';
import { UpdatePasswordBodyDTO } from '@account/interface/dto/update-password.body.dto';
import { WithdrawBodyDTO } from '@account/interface/dto/withdraw.body.dto';
import { RemitBodyDTO } from '@account/interface/dto/remit.body.dto';
import { WithdrawParamDTO } from '@account/interface/dto/withdraw.param.dto';
import { DepositParamDTO } from '@account/interface/dto/deposit.param.dto';
import { RemitParamDTO } from '@account/interface/dto/remit.param.dto';
import { UpdatePasswordParamDTO } from '@account/interface/dto/update-password.param.dto';
import { DeleteAccountParamDTO } from '@account/interface/dto/delete-account.param.dto';
import { DeleteAccountQueryDTO } from '@account/interface/dto/delete-account.query.dto';
import { FindAccountByIdParamDTO } from '@account/interface/dto/find-account-by-id.param.dto';
import { FindAccountByIdResponseDTO } from '@account/interface/dto/find-account-by-id.response.dto';
import { FindAccountsResponseDTO } from '@account/interface/dto/find-accounts.response.dto';
import { ResponseDescription } from '@account/interface/response-description';
